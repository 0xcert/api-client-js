...
export class Client {
  ...
  public async init() {
    ...
    this.payment.assetApproveCost = data.payment.assetApproveCost;
    this.payment.dappValueApproveCost = data.payment.dappValueApproveCost;
   ...
   * @param priority Priority.
   */
  public async createApproval(approveData: DappValueApproveData | AssetApproveData, priority: Priority) {
    if (typeof approveData['ledgerId'] === 'string') {
      return this.approvalsController.createAssetApproval(approveData as AssetApproveData, priority);
    } else {
      return this.approvalsController.createDappValueApproval(approveData as DappValueApproveData, priority);
    }
  }
